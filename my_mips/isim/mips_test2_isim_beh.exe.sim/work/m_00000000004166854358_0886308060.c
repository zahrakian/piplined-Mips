...
LAB20:    t407 = (t0 + 5320);
    ...
    *((unsigned int *)t417) = (t419 | t413);
    xsi_driver_vfirst_trans(t407, 0, 15);
    t420 = (t0 + 5224);
    *((int *)t420) = 1;
...
LAB70:    if (*((unsigned int *)t149) > 0)
        goto LAB71;

LAB72:    if (*((unsigned int *)t123) > 0)
        goto LAB73;

LAB74:    memcpy(t122, t161, 8);

LAB75:    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t79, 32, t109, 32, t122, 32);
    goto LAB54;

LAB52:    memcpy(t79, t109, 8);
    goto LAB54;

LAB55:    *((unsigned int *)t109) = 1;
    goto LAB58;
...
LAB67:    t153 = (t0 + 1368U);
    ...
    t155 = *((char **)t153);
    memset(t156, 0, 8);
    xsi_vlog_unsigned_lshift(t156, 32, t154, 16, t155, 16);
    goto LAB68;
...
LAB77:    *((unsigned int *)t164) = 1;

LAB79:    memset(t162, 0, 8);
    t180 = (t164 + 4);
...
LAB89:    if (*((unsigned int *)t162) > 0)
        goto LAB90;

LAB91:    memcpy(t161, t199, 8);

LAB92:    goto LAB70;

LAB71:    xsi_vlog_unsigned_bit_combine(t122, 32, t156, 32, t161, 32);
    goto LAB75;

LAB73:    memcpy(t122, t156, 8);
    goto LAB75;
...
LAB84:    t191 = (t0 + 1368U);
    ...
    t193 = *((char **)t191);
    memset(t194, 0, 8);
    xsi_vlog_unsigned_rshift(t194, 32, t192, 16, t193, 16);
    goto LAB85;
...
LAB104:    if (*((unsigned int *)t225) > 0)
        goto LAB105;

LAB106:    if (*((unsigned int *)t200) > 0)
        goto LAB107;

LAB108:    memcpy(t199, t267, 8);

LAB109:    goto LAB87;

LAB88:    xsi_vlog_unsigned_bit_combine(t161, 32, t194, 32, t199, 32);
    goto LAB92;

LAB90:    memcpy(t161, t194, 8);
    goto LAB92;
...
LAB114:    *((unsigned int *)t271) = 1;

LAB116:    memset(t268, 0, 8);
    t287 = (t271 + 4);
...
LAB124:    if (*((unsigned int *)t294) > 0)
        goto LAB125;

LAB126:    if (*((unsigned int *)t268) > 0)
        goto LAB127;

LAB128:    memcpy(t267, t332, 8);

LAB129:    goto LAB104;

LAB105:    xsi_vlog_unsigned_bit_combine(t199, 32, t232, 32, t267, 32);
    goto LAB109;

LAB107:    memcpy(t199, t232, 8);
    goto LAB109;

LAB110:    t243 = *((unsigned int *)t232);
...
LAB141:    if (*((unsigned int *)t353) < *((unsigned int *)t354))
        goto LAB139;

LAB140:    t359 = *((unsigned int *)t336);
...
LAB152:    if (*((unsigned int *)t397) > 0)
        goto LAB153;

LAB154:    if (*((unsigned int *)t333) > 0)
        goto LAB155;

LAB156:    memcpy(t332, t406, 8);

LAB157:    goto LAB124;

LAB125:    xsi_vlog_unsigned_bit_combine(t267, 32, t301, 32, t332, 32);
    goto LAB129;

LAB127:    memcpy(t267, t301, 8);
    goto LAB129;

LAB130:    t312 = *((unsigned int *)t301);
...
LAB149:    t401 = ((char*)((ng1)));
    goto LAB150;

LAB151:    t406 = ((char*)((ng10)));
    goto LAB152;

LAB153:    xsi_vlog_unsigned_bit_combine(t332, 32, t401, 32, t406, 32);
    goto LAB157;

LAB155:    memcpy(t332, t401, 8);
    goto LAB157;
...
{
	static char *pe[] = {(void *)Always_39_0,(void *)Always_45_1,(void *)Cont_52_2,(void *)Cont_61_3};
	xsi_register_didat("work_m_00000000004166854358_0886308060", "isim/mips_test2_isim_beh.exe.sim/work/m_00000000004166854358_0886308060.didat");
